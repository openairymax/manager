#!/usr/bin/env python3
"""
AgentRT Configuration Drift Detector
...
"""
        ...
        md_content += f"\n---\n*Generated by AgentRT Config Drift Detector v1.0*\n"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="AgentRT Configuration Drift Detector",
...
Examples:
  ...
  python drift_detector.py --action detect --verbose --output report.json
    ...
    parser.add_argument(
        "--config-dir",
        type=Path,
        default=Path(__file__).parent.parent.parent.parent / "manager",
